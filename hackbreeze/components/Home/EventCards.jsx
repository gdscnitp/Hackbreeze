  ...
  return (
    <div className="card bg-white rounded-md">
      <div className="flex">
        ...
        <div className="card-calender-svg">{/* //for the time logo */}</div>
        <div>
          <p className="card-date-time font-poppins text-gray-800 text-[7px] mt-2 ml-14 font-bold text-opacity-70">
